...
#endif
#if defined(UART5)
    using Uart5 = Private::Usart<Private::Uart5Regs, UART5_IRQn, Clock::Uart4Clock, Private::Uart5TxPins, Private::Uart5RxPins, Dma2Stream1Channel2, Dma2Stream1Channel2>;
#endif
}
