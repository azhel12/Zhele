...
namespace Zhele::Containers
{
     ...
     */
    template<unsigned _Size, typename _DataType, typename _Atomic = VoidAtomic>
    class RingBufferPO2
    {
    ...
    private:
        ...
        static const size_type _mask = _Size - 1;
    };
    
    template<size_t _Size, typename _DataType = uint8_t, typename _Atomic = VoidAtomic>
    class RingBuffer
    {
    public:
        using size_type = typename Zhele::TemplateUtils::SuitableUnsignedTypeForLength<_Size>::type;
