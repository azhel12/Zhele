/**
 * @file
 * Implements FLASH for stm32c0 series
 *
...
#ifndef ZHELE_PLATFORM_STM32_C0_FLASH_H
#define ZHELE_PLATFORM_STM32_C0_FLASH_H

#include <stm32c0xx.h>

#if !defined (FLASH_SIZE) && !defined (FLASH_END)
...
#endif //! ZHELE_PLATFORM_STM32_C0_FLASH_H
