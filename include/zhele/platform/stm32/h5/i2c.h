/**
 * @file
 * Implement i2c protocol for stm32h5 series
 *
...
#ifndef ZHELE_PLATFORM_STM32_H5_I2C_H
#define ZHELE_PLATFORM_STM32_H5_I2C_H
...
namespace Zhele
{
    namespace Private
    {
        ...
        struct I2c1SclPins
        {
            using io_pins = IO::PinList<IO::Pb6, IO::Pb8, IO::Pc8>;
            static constexpr std::array<uint8_t, 3> alt_functions{4, 4, 4};
        };
        struct I2c1SdaPins
        {
            using io_pins = IO::PinList<IO::Pb5, IO::Pb7, IO::Pb10, IO::Pc9>;
            static constexpr std::array<uint8_t, 4> alt_functions{11, 4, 11, 4};
        };

        struct I2c2SclPins
        {
            using io_pins = IO::PinList<IO::Pb3, IO::Pb5, IO::Pb10, IO::Pc6, IO::Pc10>;
            static constexpr std::array<uint8_t, 5> alt_functions{8, 8, 4, 8, 8};
        };
        struct I2c2SdaPins
        {
            using io_pins = IO::PinList<IO::Pb3, IO::Pb4, IO::Pb8, IO::Pb13, IO::Pc7, IO::Pc11>;
            static constexpr std::array<uint8_t, 6> alt_functions{4, 8, 8, 4, 8, 8};
        };
...
#endif //! ZHELE_PLATFORM_STM32_H5_I2C_H
