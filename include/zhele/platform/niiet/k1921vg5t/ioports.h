/**
 * @file
 * K1921VG5T: instantiate GPIO port types (Porta, Portb).
 *
 * Port A is 16-bit, port B is 15-bit (B15 does not exist on the LQFP-48 package).
 */
#ifndef ZHELE_PLATFORM_NIIET_K1921VG5T_IOPORTS_H
#define ZHELE_PLATFORM_NIIET_K1921VG5T_IOPORTS_H
...
#endif // ZHELE_PLATFORM_NIIET_K1921VG5T_IOPORTS_H
