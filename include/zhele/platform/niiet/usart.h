/**
 * @file
 * UART for NIIET — dispatches to the correct device implementation.
 */
#ifndef ZHELE_PLATFORM_NIIET_USART_H
#define ZHELE_PLATFORM_NIIET_USART_H

// Run the device detector even if ZHELE_PLATFORM_NIIET was set externally.
#include "platform_detector.h"

#if defined(ZHELE_NIIET_DEVICE_K1921VG015)
  #include "k1921vg015/usart.h"
#elif defined(ZHELE_NIIET_DEVICE_K1921VG5T)
  #include "k1921vg5t/usart.h"
#elif defined(ZHELE_NIIET_DEVICE_K1921VG7T)
  #include "k1921vg7t/usart.h"
#else
...
#endif // ZHELE_PLATFORM_NIIET_USART_H
