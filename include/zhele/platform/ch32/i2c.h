/**
 * @file
 * I2C for CH32 — dispatches to the correct family implementation.
 */
#ifndef ZHELE_PLATFORM_CH32_I2C_H
#define ZHELE_PLATFORM_CH32_I2C_H
...
#  error "Zhele: CH32 V1/V3 I2C not yet implemented. Contributions welcome."
#else
...
#endif // ZHELE_PLATFORM_CH32_I2C_H
