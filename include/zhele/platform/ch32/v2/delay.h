/**
 * @file
 * Busy-loop delay for CH32V20x series.
 */
#ifndef ZHELE_PLATFORM_CH32_V2_DELAY_H
#define ZHELE_PLATFORM_CH32_V2_DELAY_H

// CH32V203: the vendor SystemInit configures 96 MHz (HSE) by default; a
// consumer running a different clock should override F_CPU.
#ifndef F_CPU
...
#endif // ZHELE_PLATFORM_CH32_V2_DELAY_H
