/**
 * @file
 * CH32V20x: instantiate the DMA1 controller and its channels.
 *
 * @note CH32V203 has a single DMA controller (DMA1) with 7 channels; there is
 *       no DMA2 on this family.
 */
#ifndef ZHELE_PLATFORM_CH32_V2_DMA_H
#define ZHELE_PLATFORM_CH32_V2_DMA_H
...
#endif // ZHELE_PLATFORM_CH32_V2_DMA_H
