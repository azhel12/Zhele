/**
 * @file
 * Delay for CH32 — dispatches to the correct family implementation.
 */
#ifndef ZHELE_PLATFORM_CH32_DELAY_H
#define ZHELE_PLATFORM_CH32_DELAY_H
...
#  error "Zhele: CH32 V1/V3 delay not yet implemented. Contributions welcome."
#else
...
#endif // ZHELE_PLATFORM_CH32_DELAY_H
