...
namespace Zhele
{
    namespace Private
    {
        ...
        */
        ...
        using Usart1TxPins = std::pair<IO::PinList<IO::Pa9, IO::Pb6, IO::Pc4>, NonTypeTemplateArray<1, 0, 1>>;
        using Usart1RxPins = std::pair<IO::PinList<IO::Pa10, IO::Pb7, IO::Pc5>, NonTypeTemplateArray<1, 0, 1>>;

        using Usart2TxPins = std::pair<IO::PinList<IO::Pa2, IO::Pa14, IO::Pd5>, NonTypeTemplateArray<1, 1, 0>>;
        using Usart2RxPins = std::pair<IO::PinList<IO::Pa3, IO::Pa15, IO::Pd6>, NonTypeTemplateArray<1, 1, 0>>;

        using Usart3TxPins = std::pair<IO::PinList<IO::Pa5, IO::Pb2, IO::Pb8, IO::Pb10, IO::Pc4, IO::Pc10>, NonTypeTemplateArray<4, 4, 4, 4, 0, 0>>;
        using Usart3RxPins = std::pair<IO::PinList<IO::Pb0, IO::Pb9, IO::Pb11, IO::Pc5, IO::Pc11>, NonTypeTemplateArray<4, 4, 4, 0, 0>>;
